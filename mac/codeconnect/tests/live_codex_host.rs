...
/// with no coordinator above it and a deliberately dead tmux socket, so there is no
/// launcher in the process tree to pin anything — this file is the *consumer* of
/// `--codex-sha256`, and synthesizing a charter is what isolating the consumer
/// means. A real launcher changes nothing about that.
