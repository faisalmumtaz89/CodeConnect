...
/// wire, from `CCDisabledReason`s and from screen copy carrying `` `codeconnect
/// pair` `` or `` `ios/CodeConnect/Net/Sender.swift` `` — and those spans are
        ...
        VStack(alignment: .leading, spacing: CC.space.xs) {
            ...
            if let reason {
                HStack(alignment: .firstTextBaseline, spacing: CC.space.xxs + 1) {
                    ...
                    // unblock it — `codeconnect pair`, `codeconnect token` — and those
